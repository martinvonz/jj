...
You can see the actual history of working copy changes using `jj evolution`.
This will show the history of the commits that were previously the "working-copy
...
You can also use `jj evolution -r` on revisions that were previously the
working-copy revisions (or on any other revisions). Use `jj evolution -p` as an
...
Use `jj evolution -p` to see how your working-copy commit has evolved. Find the
