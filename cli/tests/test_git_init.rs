...
fn test_git_init_external_in_worktree_pointing_worktree() {
    ...
    insta::assert_snapshot!(stdout, @r#"
    @  3526c2b2b7a1 new empty commit
    │  args: jj new
    ○  ad7ce214e638 import git head
    │  args: jj git init --git-repo .
    ○  28f0150f7beb import git refs
    │  args: jj git init --git-repo .
    ○  1dd8979af5cf add workspace 'default'
    ○  000000000000
    "#);
}
...
fn test_git_init_external_in_worktree_pointing_commondir() {
    ...
    let stdout = test_env.jj_cmd_success(&workspace_root, OP_LOG_COMPACT);
    insta::assert_snapshot!(stdout, @r#"
    @  7323c066b77f new empty commit
    │  args: jj new
    ○  67ea1129e945 import git head
    │  args: jj git init --git-repo ../git-repo
    ○  eb54118823c4 import git refs
    │  args: jj git init --git-repo ../git-repo
    ○  1dd8979af5cf add workspace 'default'
    ○  000000000000
    "#);
