...
fn test_annotate_linear() {
    ...
    qpvuntsm 66a7eee9 foo      2001-02-03    1: line1
    kkmpptxz f9b81c5a test.use 2001-02-03    2: new text from new commit
    "#);
}
...
fn test_annotate_merge() {
    ...
    let stdout = test_env.jj_cmd_success(&repo_path, &["file", "annotate", "file.txt"]);
    insta::assert_snapshot!(stdout, @r#"
    qpvuntsm 8934c772 test.use 2001-02-03    1: line1
    zsuskuln 712ba14a test.use 2001-02-03    2: new text from new commit 1
    royxmykx b0571bd9 test.use 2001-02-03    3: new text from new commit 2
    "#);
}
...
fn test_annotate_conflicted() {
    ...
    insta::assert_snapshot!(stdout, @r##"
    qpvuntsm 8934c772 test.use 2001-02-03    1: line1
    yostqsxw 7b90c9f6 test.use 2001-02-03    2: <<<<<<< Conflict 1 of 1
    yostqsxw 7b90c9f6 test.use 2001-02-03    3: %%%%%%% Changes from base to side #1
    yostqsxw 7b90c9f6 test.use 2001-02-03    4: +new text from new commit 1
    yostqsxw 7b90c9f6 test.use 2001-02-03    5: +++++++ Contents of side #2
    royxmykx b0571bd9 test.use 2001-02-03    6: new text from new commit 2
    yostqsxw 7b90c9f6 test.use 2001-02-03    7: >>>>>>> Conflict 1 of 1 ends
    "##);
}
